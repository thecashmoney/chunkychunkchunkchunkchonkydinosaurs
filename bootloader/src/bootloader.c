...
void load_firmware(void) {
  ...
  // uint32_t num_frames;
   ...
   hasPadding = fw_size % FRAME_BODY_LEN != 0;
   for (int i = 0; i < num_frames; i++) {
       ...
       // Writing a frame of the firmware to flash - commenting out for now
